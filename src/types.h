...
struct monster_type
{
	...
	byte is_pet;		/* Is monster summoned - will fight for you? */
	byte is_friendly;		/* Non-aggressive monster (tamed/charmed) */
...
struct player_type
{
	...
	s16b ts_anchor;		/* Timed -- Time/Space Anchor */
	...
	s16b tim_sus_dex;		/* Timed -- sustain dexterity -KMW- */
	s16b tim_sus_con;		/* Timed -- sustain constitution -KMW- */
	s16b tim_sus_chr;		/* Timed -- sustain charisma -KMW- */
	...
	bool invisible;		/* Player Invisibility */
	bool ghostly;		/* Player walk through walls */
	bool free_act;		/* Free action */
	bool hold_life;		/* Hold life */
	bool levitate;		/* levitating - cross terrains -KMW- */
